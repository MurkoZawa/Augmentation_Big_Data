...
2) Aprire il Notebook filtered_extraction.ipynb e runnare tutte le sezioni in ordine. Al momento dell'input, immettere il numero di righe che si desidera leggere dal .inter (ex. 1 se si vuole un milione, 0.5 se si vogliono 500.000 ecc.). Verrà generato un DataFrame frutto dei merge tra i file contenenti informazioni su tracce, artisti e relazioni tra utenti e tracce, che sarà la base da cui partire per effettuare l'augmentation.
